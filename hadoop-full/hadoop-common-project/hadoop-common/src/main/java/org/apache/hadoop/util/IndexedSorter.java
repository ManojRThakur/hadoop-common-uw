...
public interface IndexedSorter {
   ...
   */
  void sort(@OsUntrusted IndexedSorter this, @OsUntrusted IndexedSortable s, @OsUntrusted int l, @OsUntrusted int r);
   ...
   */
  void sort(@OsUntrusted IndexedSorter this, @OsUntrusted IndexedSortable s, @OsUntrusted int l, @OsUntrusted int r, @OsUntrusted Progressable rep);

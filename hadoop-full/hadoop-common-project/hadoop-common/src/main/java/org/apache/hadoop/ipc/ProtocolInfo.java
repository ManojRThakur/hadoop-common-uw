...
public @interface ProtocolInfo {
  @OsUntrusted
  String protocolName(@OsUntrusted ProtocolInfo this);  // the name of the protocol (i.e. rpc service)
  @OsUntrusted
  long protocolVersion(@OsUntrusted ProtocolInfo this) default -1; // default means not defined use old way
}

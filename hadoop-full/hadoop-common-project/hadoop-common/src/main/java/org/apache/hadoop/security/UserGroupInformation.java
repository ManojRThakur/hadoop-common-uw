...
public class UserGroupInformation {
   ...
   */
  public static @OsUntrusted boolean isSecurityEnabled() {
  ...
  private static class HadoopConfiguration 
    ...
    static {
      ...
      @OsTrusted String ticketCache = System.getenv("KRB5CCNAME");
      if (ticketCache != null) {
        if (IBM_JAVA) {
   ...
   */
  public @OsUntrusted boolean hasKerberosCredentials(@OsUntrusted UserGroupInformation this) {
  ...
  @InterfaceStability.Evolving
  public synchronized
  static @OsUntrusted UserGroupInformation getCurrentUser() throws IOException {
   ...
   */ 
  public static @OsUntrusted UserGroupInformation getBestUGI(
      @OsTrusted String ticketCachePath, @OsUntrusted String user) throws IOException {
  ...
  public static UserGroupInformation getUGIFromTicketCache(
            @OsTrusted String ticketCache, String user) throws IOException {
    if (!isAuthenticationMethodEnabled(AuthenticationMethod.KERBEROS)) {
  ...
  @InterfaceStability.Evolving
  public synchronized 
  static @OsUntrusted UserGroupInformation getLoginUser() throws IOException {
    if (loginUser == null) {
      ensureInitialized();
      try {
  ...
  @InterfaceStability.Evolving
  public synchronized
  static void loginUserFromKeytab(@OsUntrusted String user,
                                  @OsUntrusted
                                  String path
                                  ) throws IOException {
    if (!isSecurityEnabled())
  ...
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  public synchronized void reloginFromKeytab(@OsUntrusted UserGroupInformation this)
  throws IOException {
    if (!isSecurityEnabled() ||
         user.getAuthenticationMethod() != AuthenticationMethod.KERBEROS ||
         !isKeytab)
  ...
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  public synchronized void reloginFromTicketCache(@OsUntrusted UserGroupInformation this)
  throws IOException {
    if (!isSecurityEnabled() || 
        user.getAuthenticationMethod() != AuthenticationMethod.KERBEROS ||
        !isKrbTkt)
  ...
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  public synchronized static @OsUntrusted boolean isLoginKeytabBased() throws IOException {
  ...
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  public static @OsUntrusted UserGroupInformation createRemoteUser(@OsUntrusted String user) {
  ...
  public static enum AuthenticationMethod {
    ...
    private final @OsTrusted String loginAppName;
    
    private AuthenticationMethod(AuthMethod authMethod) {
      this(authMethod, null);
    }
    private AuthenticationMethod(AuthMethod authMethod, @OsTrusted String loginAppName) {
      this.authMethod = authMethod;
      this.loginAppName = loginAppName;
    }
    
    public @OsUntrusted AuthMethod getAuthMethod(UserGroupInformation.@OsUntrusted AuthenticationMethod this) {
      return authMethod;
    }
  ...
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  public static @OsUntrusted UserGroupInformation createProxyUser(@OsUntrusted String user,
      @OsUntrusted
  ...
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  public @OsUntrusted UserGroupInformation getRealUser(@OsUntrusted UserGroupInformation this) {
   ...
   */
  public @OsUntrusted String getShortUserName(@OsUntrusted UserGroupInformation this) {
  ...
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  public @OsTrusted String getUserName(@OsUntrusted UserGroupInformation this) {
    return user.getName();
  }
   ...
   */
  public synchronized @OsUntrusted boolean addTokenIdentifier(@OsUntrusted UserGroupInformation this, @OsUntrusted TokenIdentifier tokenId) {
  ...
  public synchronized
  @OsUntrusted
  Collection<@OsUntrusted Token<@OsUntrusted ? extends @OsUntrusted TokenIdentifier>> getTokens(@OsUntrusted UserGroupInformation this) {
   ...
   */
  public synchronized void addCredentials(@OsUntrusted UserGroupInformation this, @OsUntrusted Credentials credentials) {
   ...
   */
  public synchronized @OsTrusted String @OsUntrusted [] getGroupNames(@OsUntrusted UserGroupInformation this) {
    ensureInitialized();
    try {
      List<@OsTrusted String> result = groups.getGroups(getShortUserName());
      return result.toArray(new @OsTrusted String[result.size()]);
    } catch (IOException ie) {
   ...
   */
  @Override
  public @OsUntrusted String toString(@OsUntrusted UserGroupInformation this) {
   ...
   */
  public synchronized 
  void setAuthenticationMethod(@OsUntrusted UserGroupInformation this, @OsUntrusted AuthenticationMethod authMethod) {
   ...
   * @param authMethod
   */
  public void setAuthenticationMethod(@OsUntrusted UserGroupInformation this, @OsUntrusted AuthMethod authMethod) {
   ...
   * @return AuthenticationMethod in the subject, null if not present.
   */
  public synchronized @OsUntrusted AuthenticationMethod getRealAuthenticationMethod(@OsUntrusted UserGroupInformation this) {
   ...
   */
  @Override
  public @OsUntrusted boolean equals(@OsUntrusted UserGroupInformation this, @OsUntrusted Object o) {
    if (o == this) {
      return true;
    } else if (o == null || getClass() != o.getClass()) {
      return false;
   ...
   */
  @Override
  public @OsUntrusted int hashCode(@OsUntrusted UserGroupInformation this) {
  ...
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  public <@OsUntrusted T extends java.lang.@OsUntrusted Object> @OsUntrusted T doAs(@OsUntrusted UserGroupInformation this, @OsUntrusted PrivilegedAction<@OsUntrusted T> action) {
  ...
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  public <@OsUntrusted T extends java.lang.@OsUntrusted Object> @OsUntrusted T doAs(@OsUntrusted UserGroupInformation this, @OsUntrusted PrivilegedExceptionAction<@OsUntrusted T> action

...
public interface BZip2Constants {
   ...
   */
  public static final @OsUntrusted int END_OF_BLOCK = -2;
  /**
   * End of BZip2 stream.
   */
  public static final @OsUntrusted int END_OF_STREAM = -1;
  ...
  * </p>
  */
  final @OsUntrusted int @OsUntrusted [] rNums = new int @OsUntrusted [] { 619, 720, 127, 481, 931, 816, 813, 233, 566, 247,

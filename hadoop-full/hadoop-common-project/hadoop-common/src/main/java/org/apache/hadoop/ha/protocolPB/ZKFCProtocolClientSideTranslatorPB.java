...
public class ZKFCProtocolClientSideTranslatorPB implements
  @OsUntrusted
  ZKFCProtocol, @OsUntrusted Closeable, @OsUntrusted ProtocolTranslator {

  private final static @OsUntrusted RpcController NULL_CONTROLLER = null;
  private final @OsUntrusted ZKFCProtocolPB rpcProxy;

  public @OsUntrusted ZKFCProtocolClientSideTranslatorPB(
      @OsUntrusted
  ...
  @Override
  public void cedeActive(@OsUntrusted ZKFCProtocolClientSideTranslatorPB this, @OsUntrusted int millisToCede) throws IOException,
  ...
  @Override
  public void gracefulFailover(@OsUntrusted ZKFCProtocolClientSideTranslatorPB this) throws IOException, AccessControlException {
    try {
  ...
  @Override
  public void close(@OsUntrusted ZKFCProtocolClientSideTranslatorPB this) {
    RPC.stopProxy(rpcProxy);
  }

  @Override
  public @OsUntrusted Object getUnderlyingProxyObject(@OsUntrusted ZKFCProtocolClientSideTranslatorPB this) {
    return rpcProxy;
  }
}

...
public interface MetricsRecord {
   ...
   */
  @OsUntrusted
  long timestamp(@OsUntrusted MetricsRecord this);

  /**
   * @return the metrics record name
   */
  @OsUntrusted
  String name(@OsUntrusted MetricsRecord this);

  /**
   * @return the description of the metrics record
   */
  @OsUntrusted
  String description(@OsUntrusted MetricsRecord this);

  /**
   * @return the context name of the metrics record
   */
  @OsUntrusted
  String context(@OsUntrusted MetricsRecord this);
   ...
   */
  @OsUntrusted
  Collection<@OsUntrusted MetricsTag> tags(@OsUntrusted MetricsRecord this);
   ...
   */
  @OsUntrusted
  Iterable<@OsUntrusted AbstractMetric> metrics(@OsUntrusted MetricsRecord this);
}

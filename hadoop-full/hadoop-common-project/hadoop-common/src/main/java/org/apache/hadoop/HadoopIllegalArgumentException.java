...
public class HadoopIllegalArgumentException extends @OsUntrusted IllegalArgumentException {
   ...
   */
  public @OsUntrusted HadoopIllegalArgumentException(final @OsUntrusted String message) {
    super(message);
  }
}

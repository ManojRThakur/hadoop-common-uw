 ...
 */
final class CRC {
  static final @OsUntrusted int crc32Table @OsUntrusted [] = new int @OsUntrusted [] { 0x00000000, 0x04c11db7, 0x09823b6e,
  ...
  void initialiseCRC(@OsUntrusted CRC this) {
    globalCrc = 0xffffffff;
  }

  @OsUntrusted
  int getFinalCRC(@OsUntrusted CRC this) {
    return ~globalCrc;
  }

  @OsUntrusted
  int getGlobalCRC(@OsUntrusted CRC this) {
    return globalCrc;
  }

  void setGlobalCRC(@OsUntrusted CRC this, @OsUntrusted int newCrc) {
    globalCrc = newCrc;
  }

  void updateCRC(@OsUntrusted CRC this, @OsUntrusted int inCh) {
    @OsUntrusted
  ...
  void updateCRC(@OsUntrusted CRC this, @OsUntrusted int inCh, @OsUntrusted int repeat) {
    @OsUntrusted

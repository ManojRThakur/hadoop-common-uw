...
class NativeCrc32 {
   ...
   */
  public static void verifyChunkedSums(@OsUntrusted int bytesPerSum, @OsUntrusted int checksumType,
      @OsUntrusted
      ByteBuffer sums, @OsUntrusted ByteBuffer data, @OsUntrusted String fileName, @OsUntrusted long basePos)
    ...
    private static native void nativeVerifyChunkedSums(
      @OsUntrusted
      int bytesPerSum, @OsUntrusted int checksumType,
      @OsUntrusted
      ByteBuffer sums, @OsUntrusted int sumsOffset,
      @OsUntrusted
      ByteBuffer data, @OsUntrusted int dataOffset, @OsUntrusted int dataLength,
      @OsUntrusted
  ...
  public static final @OsUntrusted int CHECKSUM_CRC32 = DataChecksum.CHECKSUM_CRC32;
  public static final @OsUntrusted int CHECKSUM_CRC32C = DataChecksum.CHECKSUM_CRC32C;
}

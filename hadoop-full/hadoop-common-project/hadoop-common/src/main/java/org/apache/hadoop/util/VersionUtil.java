...
public abstract class VersionUtil {
  ...
  private static final @OsUntrusted Pattern COMPONENT_GROUPS = Pattern.compile("(\\d+)|(\\D+)");
   ...
   */
  private static final @OsUntrusted String SNAPSHOT_SUFFIX = "-SNAPSHOT";
   ...
   *         versions are equal.
   */
  public static @OsUntrusted int compareVersions(@OsUntrusted String version1, @OsUntrusted String version2) {
    @OsUntrusted
    ...
    @OsUntrusted
    String @OsUntrusted [] version1Parts = version1.split("\\.");
    @OsUntrusted
    String @OsUntrusted [] version2Parts = version2.split("\\.");
    
    for (@OsUntrusted int i = 0; i < version1Parts.length && i < version2Parts.length; i++) {
      @OsUntrusted
  ...
  private static @OsUntrusted String stripSnapshotSuffix(@OsUntrusted String version) {
  ...
  private static @OsUntrusted boolean isNumeric(@OsUntrusted String s) {
    try {
      Integer.parseInt(s);
      return true;

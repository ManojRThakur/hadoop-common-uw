 ...
 *
 */
public class GangliaSink31 extends @OsUntrusted GangliaSink30 {
   ...
   */
  @Override
  protected void emitMetric(@OsUntrusted GangliaSink31 this, @OsUntrusted String groupName, @OsUntrusted String name, @OsUntrusted String type,
      @OsUntrusted
      String value, @OsUntrusted GangliaConf gConf, @OsUntrusted GangliaSlope gSlope) 
    throws IOException {

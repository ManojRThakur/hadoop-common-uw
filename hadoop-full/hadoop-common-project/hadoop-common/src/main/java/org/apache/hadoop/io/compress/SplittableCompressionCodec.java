...
public interface SplittableCompressionCodec extends @OsUntrusted CompressionCodec {
   ...
   */
  public enum READ_MODE {  @OsUntrusted  CONTINUOUS,  @OsUntrusted  BYBLOCK};
   ...
   */
  @OsUntrusted
  SplitCompressionInputStream createInputStream(@OsUntrusted SplittableCompressionCodec this, @OsUntrusted InputStream seekableIn,
      @OsUntrusted

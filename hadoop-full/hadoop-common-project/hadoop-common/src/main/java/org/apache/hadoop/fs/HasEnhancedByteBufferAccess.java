...
public interface HasEnhancedByteBufferAccess {
   ...
   */
  public @OsUntrusted ByteBuffer read(@OsUntrusted HasEnhancedByteBufferAccess this, @OsUntrusted ByteBufferPool factory, @OsUntrusted int maxLength,
      @OsUntrusted
   ...
   */
  public void releaseBuffer(@OsUntrusted HasEnhancedByteBufferAccess this, @OsUntrusted ByteBuffer buffer);
}
 ...
 */
public class RpcException extends @OsUntrusted IOException {
   ...
   */
  @OsUntrusted
  RpcException(final @OsUntrusted String message) {
    super(message);
  }
   ...
   */
  @OsUntrusted
  RpcException(final @OsUntrusted String message, final @OsUntrusted Throwable cause) {
    super(message, cause);
  }
}

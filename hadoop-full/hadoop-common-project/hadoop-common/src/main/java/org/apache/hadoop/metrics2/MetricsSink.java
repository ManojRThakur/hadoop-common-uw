...
public interface MetricsSink extends @OsUntrusted MetricsPlugin {
  /**
   * Put a metrics record in the sink
   * @param record  the record to put
   */
  void putMetrics(@OsUntrusted MetricsSink this, @OsUntrusted MetricsRecord record);

  /**
   * Flush any buffered metrics
   */
  void flush(@OsUntrusted MetricsSink this);
}

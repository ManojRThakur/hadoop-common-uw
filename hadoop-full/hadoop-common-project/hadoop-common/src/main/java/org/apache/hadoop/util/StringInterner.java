...
public class StringInterner {
   ...
   */
  private final static @OsUntrusted Interner<@OsUntrusted String> strongInterner;
  
  /**
   * Retains a weak reference to each string instance it has interned. 
   */
  private final static @OsUntrusted Interner<@OsUntrusted String> weakInterner;
   ...
   */
  public static @OsUntrusted String strongIntern(@OsUntrusted String sample) {
    if (sample == null) {
      return null;
    }
   ...
   */
  public static @OsUntrusted String weakIntern(@OsUntrusted String sample) {
    if (sample == null) {
      return null;
    }

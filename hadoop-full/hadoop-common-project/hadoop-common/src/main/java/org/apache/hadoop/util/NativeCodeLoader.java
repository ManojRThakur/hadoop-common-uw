...
public class NativeCodeLoader {
  ...
  private static @OsUntrusted boolean nativeCodeLoaded = false;
   ...
   */
  public static native @OsUntrusted boolean buildSupportsSnappy();

  public static native @OsUntrusted String getLibraryName();
   ...
   */
  public @OsUntrusted boolean getLoadNativeLibraries(@OsUntrusted NativeCodeLoader this, @OsUntrusted Configuration conf) {
   ...
   */
  public void setLoadNativeLibraries(@OsUntrusted NativeCodeLoader this, @OsUntrusted Configuration conf, 
                                     @OsUntrusted

...
public class ShutdownThreadsHelper {
  private static @OsUntrusted Log LOG = LogFactory.getLog(ShutdownThreadsHelper.class);

  @VisibleForTesting
  static final @OsUntrusted int SHUTDOWN_WAIT_MS = 3000;
   ...
   */
  public static @OsUntrusted boolean shutdownThread(@OsUntrusted Thread thread) {
   ...
   * @throws InterruptedException
   */
  public static @OsUntrusted boolean shutdownExecutorService(@OsUntrusted ExecutorService service)
      throws InterruptedException {

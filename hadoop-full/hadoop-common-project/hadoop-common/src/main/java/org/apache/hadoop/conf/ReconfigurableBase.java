...
public abstract class ReconfigurableBase 
  extends @OsUntrusted Configured implements @OsUntrusted Reconfigurable {
   ...
   */
  public @OsUntrusted ReconfigurableBase() {
    super(new @OsUntrusted Configuration());
  }
   ...
   * conf.
   */
  public @OsUntrusted ReconfigurableBase(@OsUntrusted Configuration conf) {
    super((conf == null) ? new @OsUntrusted Configuration() : conf);
  }
   ...
   */
  @Override
  public final @OsUntrusted String reconfigureProperty(@OsUntrusted ReconfigurableBase this, @OsUntrusted String property, @OsTrusted String newVal)
    ...
    if (isPropertyReconfigurable(property)) {
      ...
      throw new @OsUntrusted ReconfigurationException(property, newVal,
   ...
   */
  @Override 
  public abstract @OsUntrusted Collection<@OsUntrusted String> getReconfigurableProperties(@OsUntrusted ReconfigurableBase this);
   ...
   */
  @Override
  public @OsUntrusted boolean isPropertyReconfigurable(@OsUntrusted ReconfigurableBase this, @OsUntrusted String property) {
   ...
   */
  protected abstract void reconfigurePropertyImpl(@OsUntrusted ReconfigurableBase this, @OsUntrusted String property, @OsUntrusted String newVal) 
    throws ReconfigurationException;

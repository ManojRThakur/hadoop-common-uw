 ...
 * service 
 */
public class UnexpectedServerException extends @OsUntrusted RpcException {
   ...
   */
  @OsUntrusted
  UnexpectedServerException(final @OsUntrusted String message) {
    super(message);
  }
   ...
   */
  @OsUntrusted
  UnexpectedServerException(final @OsUntrusted String message, final @OsUntrusted Throwable cause) {
    super(message, cause);
  }
}

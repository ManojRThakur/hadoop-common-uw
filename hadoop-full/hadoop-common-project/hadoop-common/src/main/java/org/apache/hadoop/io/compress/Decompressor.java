...
public interface Decompressor {
   ...
   * @param len Length
   */
  public void setInput(@OsUntrusted Decompressor this, @OsUntrusted byte @OsUntrusted [] b, @OsUntrusted int off, @OsUntrusted int len);
   ...
   */
  public @OsUntrusted boolean needsInput(@OsUntrusted Decompressor this);
   ...
   * @param len Length
   */
  public void setDictionary(@OsUntrusted Decompressor this, @OsUntrusted byte @OsUntrusted [] b, @OsUntrusted int off, @OsUntrusted int len);
   ...
   */
  public @OsUntrusted boolean needsDictionary(@OsUntrusted Decompressor this);
   ...
   */
  public @OsUntrusted boolean finished(@OsUntrusted Decompressor this);
   ...
   * @throws IOException
   */
  public @OsUntrusted int decompress(@OsUntrusted Decompressor this, @OsUntrusted byte @OsUntrusted [] b, @OsUntrusted int off, @OsUntrusted int len) throws IOException;
   ...
   */
  public @OsUntrusted int getRemaining(@OsUntrusted Decompressor this);
   ...
   */
  public void reset(@OsUntrusted Decompressor this);

  /**
   * Closes the decompressor and discards any unprocessed input.
   */
  public void end(@OsUntrusted Decompressor this); 
}

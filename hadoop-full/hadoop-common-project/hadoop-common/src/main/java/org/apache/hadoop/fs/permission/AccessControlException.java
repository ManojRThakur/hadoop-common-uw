...
public class AccessControlException extends @OsUntrusted IOException {
   ...
   */
  public @OsUntrusted AccessControlException() {
   ...
   */
  public @OsUntrusted AccessControlException(@OsUntrusted String s) {
    super(s);
  }
   ...
   *         unknown.)
   */
  public @OsUntrusted AccessControlException(@OsUntrusted Throwable cause) {
    super(cause);
  }
}

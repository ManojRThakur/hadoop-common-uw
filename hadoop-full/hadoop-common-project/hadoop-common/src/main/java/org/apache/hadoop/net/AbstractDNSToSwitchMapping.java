...
public abstract class AbstractDNSToSwitchMapping
    implements @OsUntrusted DNSToSwitchMapping, @OsUntrusted Configurable {
   ...
   */
  protected @OsUntrusted AbstractDNSToSwitchMapping() {
  }
   ...
   */
  protected @OsUntrusted AbstractDNSToSwitchMapping(@OsUntrusted Configuration conf) {
    this.conf = conf;
  }

  @Override
  public @OsUntrusted Configuration getConf(@OsUntrusted AbstractDNSToSwitchMapping this) {
    return conf;
  }

  @Override
  public void setConf(@OsUntrusted AbstractDNSToSwitchMapping this, @OsUntrusted Configuration conf) {
    this.conf = conf;
  }
   ...
   */
  public @OsUntrusted boolean isSingleSwitch(@OsUntrusted AbstractDNSToSwitchMapping this) {
    return false;
  }
   ...
   */
  public @OsUntrusted Map<@OsUntrusted String, @OsUntrusted String> getSwitchMap(@OsUntrusted AbstractDNSToSwitchMapping this) {
    return null;
  }
   ...
   * debug messages.
   */
  public @OsUntrusted String dumpTopology(@OsUntrusted AbstractDNSToSwitchMapping this) {
    @OsUntrusted
    Map<@OsUntrusted String, @OsUntrusted String> rack = getSwitchMap();
    @OsUntrusted
    ...
    if (rack != null) {
      builder.append("Map:\n");
      @OsUntrusted
      Set<@OsUntrusted String> switches = new @OsUntrusted HashSet<@OsUntrusted String>();
      for (Map.@OsUntrusted Entry<@OsUntrusted String, @OsUntrusted String> entry : rack.entrySet()) {
        builder.append("  ")
            .append(entry.getKey())
            .append(" -> ")
  ...
  protected @OsUntrusted boolean isSingleSwitchByScriptPolicy(@OsUntrusted AbstractDNSToSwitchMapping this) {
    return conf != null
   ...
   */
  public static @OsUntrusted boolean isMappingSingleSwitch(@OsUntrusted DNSToSwitchMapping mapping) {
    return mapping != null && mapping instanceof @OsUntrusted AbstractDNSToSwitchMapping
        && ((@OsUntrusted AbstractDNSToSwitchMapping) mapping).isSingleSwitch();
  }

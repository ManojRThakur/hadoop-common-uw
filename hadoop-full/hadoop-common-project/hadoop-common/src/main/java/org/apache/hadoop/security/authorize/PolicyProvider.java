...
public abstract class PolicyProvider {
   ...
   */
  public static final @OsUntrusted String POLICY_PROVIDER_CONFIG = 
    "hadoop.security.authorization.policyprovider";
  
  /**
   * A default {@link PolicyProvider} without any defined services.
   */
  public static final @OsUntrusted PolicyProvider DEFAULT_POLICY_PROVIDER =
    new @OsUntrusted PolicyProvider() {
    @Override
    public @OsUntrusted Service @OsUntrusted [] getServices() {
      return null;
    }
  };
   ...
   */
  public abstract @OsUntrusted Service @OsUntrusted [] getServices(@OsUntrusted PolicyProvider this);
}

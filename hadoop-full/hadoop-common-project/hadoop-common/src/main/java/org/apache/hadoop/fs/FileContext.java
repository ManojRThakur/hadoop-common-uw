...
public final class FileContext {
  ...
  public static final @OsUntrusted Log LOG = LogFactory.getLog(FileContext.class);
  /**
   ...
   */
  public static final @OsUntrusted FsPermission DEFAULT_PERM = FsPermission.getDefault();
  /**
   * Default permission for directory
   */
  public static final @OsUntrusted FsPermission DIR_DEFAULT_PERM = FsPermission.getDirDefault();
  /**
   * Default permission for file
   */
  public static final @OsUntrusted FsPermission FILE_DEFAULT_PERM = FsPermission.getFileDefault();

  /**
   * Priority of the FileContext shutdown hook.
   */
  public static final @OsUntrusted int SHUTDOWN_HOOK_PRIORITY = 20;

  /**
   * List of files that should be deleted on JVM shutdown.
   */
  static final @OsUntrusted Map<@OsUntrusted FileContext, @OsUntrusted Set<@OsUntrusted Path>> DELETE_ON_EXIT = 
    new @OsUntrusted IdentityHashMap<@OsUntrusted FileContext, @OsUntrusted Set<@OsUntrusted Path>>();

  /** JVM shutdown hook thread. */
  static final @OsUntrusted FileContextFinalizer FINALIZER = 
    new @OsUntrusted FileContextFinalizer();
  
  private static final @OsUntrusted PathFilter DEFAULT_FILTER = new @OsUntrusted PathFilter() {
    @Override
    public @OsUntrusted boolean accept(final @OsUntrusted Path file) {
      return true;
    }
  };
   ...
   *  3) umask
   */   
  private final @OsUntrusted AbstractFileSystem defaultFS; //default FS for this FileContext.
  private @OsUntrusted Path workingDir;          // Fully qualified
  private @OsUntrusted FsPermission umask;
  private final @OsUntrusted Configuration conf;
  private final @OsUntrusted UserGroupInformation ugi;
  final @OsUntrusted boolean resolveSymlinks;

  private @OsUntrusted FileContext(final @OsUntrusted AbstractFileSystem defFs,
    final @OsUntrusted FsPermission theUmask, final @OsUntrusted Configuration aConf) {
    defaultFS = defFs;
    ...
    try {
      ...
      throw new @OsUntrusted RuntimeException("Failed to get the current user " +
    ...
    util = new @OsUntrusted Util(); // for the inner class
  }
   ...
   */
  @OsUntrusted
  Path fixRelativePart(@OsUntrusted FileContext this, @OsUntrusted Path p) {
    if (p.isUriPathAbsolute()) {
      return p;
    } else {
      return new @OsUntrusted Path(workingDir, p);
    }
  }
  ...
  static void processDeleteOnExit() {
    synchronized (DELETE_ON_EXIT) {
      @OsUntrusted
      Set<@OsUntrusted Entry<@OsUntrusted FileContext, @OsUntrusted Set<@OsUntrusted Path>>> set = DELETE_ON_EXIT.entrySet();
      for (@OsUntrusted Entry<@OsUntrusted FileContext, @OsUntrusted Set<@OsUntrusted Path>> entry : set) {
        @OsUntrusted
        FileContext fc = entry.getKey();
        @OsUntrusted
        Set<@OsUntrusted Path> paths = entry.getValue();
   ...
   *         not be instantiated.
   */
  protected @OsUntrusted AbstractFileSystem getFSofPath(@OsUntrusted FileContext this, final @OsUntrusted Path absOrFqPath)
    ...
    try { 
      ...
      return defaultFS;
    } catch (@OsUntrusted Exception e) { // it is different FileSystem
      return getAbstractFileSystem(ugi, absOrFqPath.toUri(), conf);
    }
  }
  
  private static @OsUntrusted AbstractFileSystem getAbstractFileSystem(
      @OsUntrusted
      UserGroupInformation user, final @OsUntrusted URI uri, final @OsUntrusted Configuration conf)
      throws UnsupportedFileSystemException, IOException {
    try {
      return user.doAs(new @OsUntrusted PrivilegedExceptionAction<@OsUntrusted AbstractFileSystem>() {
        @Override
        public @OsUntrusted AbstractFileSystem run() throws UnsupportedFileSystemException {
          return AbstractFileSystem.get(uri, conf);
        }
      });
    } catch (@OsUntrusted InterruptedException ex) {
      LOG.error(ex);
      throw new @OsUntrusted IOException("Failed to get the AbstractFileSystem for path: "
          + uri, ex);
    }
  }
   ...
   */
  public static @OsUntrusted FileContext getFileContext(final @OsUntrusted AbstractFileSystem defFS,
                    final @OsUntrusted Configuration aConf) {
    return new @OsUntrusted FileContext(defFS, FsPermission.getUMask(aConf), aConf);
  }
   ...
   *                 as the default FS.
   */
  protected static @OsUntrusted FileContext getFileContext(
    final @OsUntrusted AbstractFileSystem defaultFS) {
    return getFileContext(defaultFS, new @OsUntrusted Configuration());
  }
   ...
   */
  public static @OsUntrusted FileContext getFileContext()
      throws UnsupportedFileSystemException {
    return getFileContext(new @OsUntrusted Configuration());
  }
   ...
   */
  public static @OsUntrusted FileContext getLocalFSFileContext()
      throws UnsupportedFileSystemException {
   ...
   */
  public static @OsUntrusted FileContext getFileContext(final @OsUntrusted URI defaultFsUri)
      throws UnsupportedFileSystemException {
    return getFileContext(defaultFsUri, new @OsUntrusted Configuration());
  }
   ...
   */
  public static @OsUntrusted FileContext getFileContext(final @OsUntrusted URI defaultFsUri,
      final @OsUntrusted Configuration aConf) throws UnsupportedFileSystemException {
    @OsUntrusted
    ...
    } catch (@OsUntrusted UnsupportedFileSystemException ex) {
      throw ex;
   ...
   *           is not supported
   */
  public static @OsUntrusted FileContext getFileContext(final @OsUntrusted Configuration aConf)
      throws UnsupportedFileSystemException {
   ...
   * 
   */
  public static @OsUntrusted FileContext getLocalFSFileContext(final @OsUntrusted Configuration aConf)
      throws UnsupportedFileSystemException {
  ...
  public @OsUntrusted AbstractFileSystem getDefaultFileSystem(@OsUntrusted FileContext this) {
    return defaultFS;
  }
   ...
   *           </ul>
   */
  public void setWorkingDirectory(@OsUntrusted FileContext this, final @OsUntrusted Path newWDir) throws IOException {
     ...
     * an absolute path.
     */  
    final @OsUntrusted Path newWorkingDir = new @OsUntrusted Path(workingDir, newWDir);
    @OsUntrusted
    FileStatus status = getFileStatus(newWorkingDir);
    if (status.isFile()) {
      throw new @OsUntrusted FileNotFoundException("Cannot setWD to a file");
    }
   ...
   */
  public @OsUntrusted Path getWorkingDirectory(@OsUntrusted FileContext this) {
    return workingDir;
  }
   ...
   */
  public @OsUntrusted UserGroupInformation getUgi(@OsUntrusted FileContext this) {
    return ugi;
  }
   ...
   */
  public @OsUntrusted Path getHomeDirectory(@OsUntrusted FileContext this) {
   ...
   */
  public @OsUntrusted FsPermission getUMask(@OsUntrusted FileContext this) {
    return umask;
  }
   ...
   */
  public void setUMask(@OsUntrusted FileContext this, final @OsUntrusted FsPermission newUmask) {
    umask = newUmask;
  }
   ...
   */
  public @OsUntrusted Path resolvePath(@OsUntrusted FileContext this, final @OsUntrusted Path f) throws FileNotFoundException,
   ...
   */
  public @OsUntrusted Path makeQualified(@OsUntrusted FileContext this, final @OsUntrusted Path path) {
   ...
   * @throws InvalidPathException If path <code>f</code> is not valid
   */
  public @OsUntrusted FSDataOutputStream create(@OsUntrusted FileContext this, final @OsUntrusted Path f,
    ...
    CreateOpts.@OsUntrusted Perms permOpt = 
      (CreateOpts.@OsUntrusted Perms) CreateOpts.getOpt(CreateOpts.Perms.class, opts);
    @OsUntrusted
    FsPermission permission = (permOpt != null) ? permOpt.getValue() :
                                      FILE_DEFAULT_PERM;
    permission = permission.applyUMask(umask);

    final @OsUntrusted CreateOpts @OsUntrusted [] updatedOpts = 
                      CreateOpts.setOpt(CreateOpts.perms(permission), opts);
    return new @OsUntrusted FSLinkResolver<@OsUntrusted FSDataOutputStream>() {
      @Override
      public @OsUntrusted FSDataOutputStream next(final @OsUntrusted AbstractFileSystem fs, final @OsUntrusted Path p) 
        throws IOException {
   ...
   */
  public void mkdir(@OsUntrusted FileContext this, final @OsUntrusted Path dir, final @OsUntrusted FsPermission permission,
      final @OsUntrusted boolean createParent) throws AccessControlException,
      FileAlreadyExistsException, FileNotFoundException,
      ParentNotDirectoryException, UnsupportedFileSystemException, 
      IOException {
    final @OsUntrusted Path absDir = fixRelativePart(dir);
    final @OsUntrusted FsPermission absFerms = (permission == null ? 
          FsPermission.getDirDefault() : permission).applyUMask(umask);
    new @OsUntrusted FSLinkResolver<@OsUntrusted Void>() {
      @Override
      public @OsUntrusted Void next(final @OsUntrusted AbstractFileSystem fs, final @OsUntrusted Path p) 
   ...
   */
  public @OsUntrusted boolean delete(@OsUntrusted FileContext this, final @OsUntrusted Path f, final @OsUntrusted boolean recursive)
      throws AccessControlException, FileNotFoundException,
      UnsupportedFileSystemException, IOException {
    @OsUntrusted
    Path absF = fixRelativePart(f);
    return new @OsUntrusted FSLinkResolver<@OsUntrusted Boolean>() {
      @Override
      public @OsUntrusted Boolean next(final @OsUntrusted AbstractFileSystem fs, final @OsUntrusted Path p) 
        throws IOException, UnresolvedLinkException {
   ...
   *           undeclared exception to RPC server
   */
  public @OsUntrusted FSDataInputStream open(@OsUntrusted FileContext this, final @OsUntrusted Path f) throws AccessControlException,
      FileNotFoundException, UnsupportedFileSystemException, IOException {
    final @OsUntrusted Path absF = fixRelativePart(f);
    return new @OsUntrusted FSLinkResolver<@OsUntrusted FSDataInputStream>() {
      @Override
      public @OsUntrusted FSDataInputStream next(final @OsUntrusted AbstractFileSystem fs, final @OsUntrusted Path p) 
        throws IOException, UnresolvedLinkException {
        return fs.open(p);
      }
    }.resolve(this, absF);
   ...
   *           undeclared exception to RPC server
   */
  public @OsUntrusted FSDataInputStream open(@OsUntrusted FileContext this, final @OsUntrusted Path f, final @OsUntrusted int bufferSize)
      throws AccessControlException, FileNotFoundException,
      UnsupportedFileSystemException, IOException {
    final @OsUntrusted Path absF = fixRelativePart(f);
    return new @OsUntrusted FSLinkResolver<@OsUntrusted FSDataInputStream>() {
   ...
   *           undeclared exception to RPC server
   */
  public @OsUntrusted boolean setReplication(@OsUntrusted FileContext this, final @OsUntrusted Path f, final @OsUntrusted short replication)
      throws AccessControlException, FileNotFoundException,
      IOException {
    final @OsUntrusted Path absF = fixRelativePart(f);
    return new @OsUntrusted FSLinkResolver<@OsUntrusted Boolean>() {
   ...
   *           undeclared exception to RPC server
   */
  public void rename(@OsUntrusted FileContext this, final @OsUntrusted Path src, final @OsUntrusted Path dst,
      final Options.@OsUntrusted Rename @OsUntrusted ... options) throws AccessControlException,
      FileAlreadyExistsException, FileNotFoundException,
      ParentNotDirectoryException, UnsupportedFileSystemException,
      IOException {
    final @OsUntrusted Path absSrc = fixRelativePart(src);
    final @OsUntrusted Path absDst = fixRelativePart(dst);
    @OsUntrusted
    AbstractFileSystem srcFS = getFSofPath(absSrc);
    @OsUntrusted
    AbstractFileSystem dstFS = getFSofPath(absDst);
    if(!srcFS.getUri().equals(dstFS.getUri())) {
      throw new @OsUntrusted IOException("Renames across AbstractFileSystems not supported");
    }
    try {
       ...
       */
      final @OsUntrusted Path source = resolveIntermediate(absSrc);    
      new @OsUntrusted FSLinkResolver<@OsUntrusted Void>() {
        @Override
        public @OsUntrusted Void next(final @OsUntrusted AbstractFileSystem fs, final @OsUntrusted Path p) 
          throws IOException, UnresolvedLinkException {
   ...
   *           undeclared exception to RPC server
   */
  public void setPermission(@OsUntrusted FileContext this, final @OsUntrusted Path f, final @OsUntrusted FsPermission permission)
      throws AccessControlException, FileNotFoundException,
      UnsupportedFileSystemException, IOException {
    final @OsUntrusted Path absF = fixRelativePart(f);
    new @OsUntrusted FSLinkResolver<@OsUntrusted Void>() {
   ...
   */
  public void setOwner(@OsUntrusted FileContext this, final @OsUntrusted Path f, final @OsTrusted String username,
   ...
   *           undeclared exception to RPC server
   */
  public void setTimes(@OsUntrusted FileContext this, final @OsUntrusted Path f, final @OsUntrusted long mtime, final @OsUntrusted long atime)
      throws AccessControlException, FileNotFoundException,
      UnsupportedFileSystemException, IOException {
    final @OsUntrusted Path absF = fixRelativePart(f);
    new @OsUntrusted FSLinkResolver<@OsUntrusted Void>() {
   ...
   *           undeclared exception to RPC server
   */
  public @OsUntrusted FileChecksum getFileChecksum(@OsUntrusted FileContext this, final @OsUntrusted Path f)
      throws AccessControlException, FileNotFoundException,
      IOException {
    final @OsUntrusted Path absF = fixRelativePart(f);
    return new @OsUntrusted FSLinkResolver<@OsUntrusted FileChecksum>() {
      @Override
      public @OsUntrusted FileChecksum next(final @OsUntrusted AbstractFileSystem fs, final @OsUntrusted Path p) 
        throws IOException, UnresolvedLinkException {
   ...
   *           undeclared exception to RPC server
   */
  public void setVerifyChecksum(@OsUntrusted FileContext this, final @OsUntrusted boolean verifyChecksum, final @OsUntrusted Path f)
      throws AccessControlException, FileNotFoundException,
      UnsupportedFileSystemException, IOException {
    final @OsUntrusted Path absF = resolve(fixRelativePart(f));
   ...
   *           undeclared exception to RPC server
   */
  public @OsUntrusted FileStatus getFileStatus(@OsUntrusted FileContext this, final @OsUntrusted Path f) throws AccessControlException,
      FileNotFoundException, UnsupportedFileSystemException, IOException {
    final @OsUntrusted Path absF = fixRelativePart(f);
    return new @OsUntrusted FSLinkResolver<@OsUntrusted FileStatus>() {
      @Override
      public @OsUntrusted FileStatus next(final @OsUntrusted AbstractFileSystem fs, final @OsUntrusted Path p) 
        throws IOException, UnresolvedLinkException {
   ...
   * @throws IOException If an I/O error occurred
   */
  public @OsUntrusted FileStatus getFileLinkStatus(@OsUntrusted FileContext this, final @OsUntrusted Path f)
      throws AccessControlException, FileNotFoundException,
      UnsupportedFileSystemException, IOException {
    final @OsUntrusted Path absF = fixRelativePart(f);
    return new @OsUntrusted FSLinkResolver<@OsUntrusted FileStatus>() {
   ...
   */
  public @OsUntrusted Path getLinkTarget(@OsUntrusted FileContext this, final @OsUntrusted Path f) throws AccessControlException,
      FileNotFoundException, UnsupportedFileSystemException, IOException {
    final @OsUntrusted Path absF = fixRelativePart(f);
    return new @OsUntrusted FSLinkResolver<@OsUntrusted Path>() {
      @Override
      public @OsUntrusted Path next(final @OsUntrusted AbstractFileSystem fs, final @OsUntrusted Path p) 
        throws IOException, UnresolvedLinkException {
        @OsUntrusted
        FileStatus fi = fs.getFileLinkStatus(p);
  ...
  public @OsUntrusted BlockLocation @OsUntrusted [] getFileBlockLocations(@OsUntrusted FileContext this, final @OsUntrusted Path f, final @OsUntrusted long start,
      final @OsUntrusted long len) throws AccessControlException, FileNotFoundException,
      UnsupportedFileSystemException, IOException {
    final @OsUntrusted Path absF = fixRelativePart(f);
    return new @OsUntrusted FSLinkResolver<@OsUntrusted BlockLocation @OsUntrusted []>() {
      @Override
      public @OsUntrusted BlockLocation @OsUntrusted [] next(final @OsUntrusted AbstractFileSystem fs, final @OsUntrusted Path p) 
        throws IOException, UnresolvedLinkException {
   ...
   *           undeclared exception to RPC server
   */
  public @OsUntrusted FsStatus getFsStatus(@OsUntrusted FileContext this, final @OsUntrusted Path f) throws AccessControlException,
      FileNotFoundException, UnsupportedFileSystemException, IOException {
    if (f == null) {
      return defaultFS.getFsStatus();
    }
    final @OsUntrusted Path absF = fixRelativePart(f);
    return new @OsUntrusted FSLinkResolver<@OsUntrusted FsStatus>() {
      @Override
      public @OsUntrusted FsStatus next(final @OsUntrusted AbstractFileSystem fs, final @OsUntrusted Path p) 
        throws IOException, UnresolvedLinkException {
   ...
   * @throws IOException If an I/O error occurred
   */
  public void createSymlink(@OsUntrusted FileContext this, final @OsUntrusted Path target, final @OsUntrusted Path link,
      final @OsUntrusted boolean createParent) throws AccessControlException,
      FileAlreadyExistsException, FileNotFoundException,
      ParentNotDirectoryException, UnsupportedFileSystemException, 
      IOException { 
    final @OsUntrusted Path nonRelLink = fixRelativePart(link);
    new @OsUntrusted FSLinkResolver<@OsUntrusted Void>() {
      @Override
      public @OsUntrusted Void next(final @OsUntrusted AbstractFileSystem fs, final @OsUntrusted Path p) 
        throws IOException, UnresolvedLinkException {
   ...
   *           undeclared exception to RPC server
   */
  public @OsUntrusted RemoteIterator<@OsUntrusted FileStatus> listStatus(@OsUntrusted FileContext this, final @OsUntrusted Path f) throws
      AccessControlException, FileNotFoundException,
      UnsupportedFileSystemException, IOException {
    final @OsUntrusted Path absF = fixRelativePart(f);
    return new @OsUntrusted FSLinkResolver<@OsUntrusted RemoteIterator<@OsUntrusted FileStatus>>() {
      @Override
      public @OsUntrusted RemoteIterator<@OsUntrusted FileStatus> next(
          final @OsUntrusted AbstractFileSystem fs, final @OsUntrusted Path p) 
        throws IOException, UnresolvedLinkException {
   ...
   * @throws IOException
   */
  public @OsUntrusted RemoteIterator<@OsUntrusted Path> listCorruptFileBlocks(@OsUntrusted FileContext this, @OsUntrusted Path path)
    throws IOException {
    final @OsUntrusted Path absF = fixRelativePart(path);
    return new @OsUntrusted FSLinkResolver<@OsUntrusted RemoteIterator<@OsUntrusted Path>>() {
      @Override
      public @OsUntrusted RemoteIterator<@OsUntrusted Path> next(final @OsUntrusted AbstractFileSystem fs,
   ...
   *           undeclared exception to RPC server
   */
  public @OsUntrusted RemoteIterator<@OsUntrusted LocatedFileStatus> listLocatedStatus(
      @OsUntrusted FileContext this, final @OsUntrusted Path f) throws
      AccessControlException, FileNotFoundException,
      UnsupportedFileSystemException, IOException {
    final @OsUntrusted Path absF = fixRelativePart(f);
    return new @OsUntrusted FSLinkResolver<@OsUntrusted RemoteIterator<@OsUntrusted LocatedFileStatus>>() {
      @Override
      public @OsUntrusted RemoteIterator<@OsUntrusted LocatedFileStatus> next(
          final @OsUntrusted AbstractFileSystem fs, final @OsUntrusted Path p) 
        throws IOException, UnresolvedLinkException {
   ...
   *           undeclared exception to RPC server
   */
  public @OsUntrusted boolean deleteOnExit(@OsUntrusted FileContext this, @OsUntrusted Path f) throws AccessControlException,
      IOException {
    ...
    synchronized (DELETE_ON_EXIT) {
      ...
      @OsUntrusted
      Set<@OsUntrusted Path> set = DELETE_ON_EXIT.get(this);
      if (set == null) {
        set = new @OsUntrusted TreeSet<@OsUntrusted Path>();
  ...
  private final @OsUntrusted Util util;
  public @OsUntrusted Util util(@OsUntrusted FileContext this) {
    return util;
  }
  ...
  public class Util {
     ...
     *           undeclared exception to RPC server
     */
    public @OsUntrusted boolean exists(@OsUntrusted FileContext.Util this, final @OsUntrusted Path f) throws AccessControlException,
      UnsupportedFileSystemException, IOException {
      try {
        @OsUntrusted
     ...
     *           undeclared exception to RPC server
     */
    private @OsUntrusted FileStatus @OsUntrusted [] getFileStatus(@OsUntrusted FileContext.Util this, @OsUntrusted Path @OsUntrusted [] paths)
        throws AccessControlException, IOException {
      if (paths == null) {
        return null;
      }
      @OsUntrusted
      ArrayList<@OsUntrusted FileStatus> results = new @OsUntrusted ArrayList<@OsUntrusted FileStatus>(paths.length);
      for (@OsUntrusted int i = 0; i < paths.length; i++) {
        try {
     ...
     *           undeclared exception to RPC server
     */
    public @OsUntrusted ContentSummary getContentSummary(@OsUntrusted FileContext.Util this, @OsUntrusted Path f)
        throws AccessControlException, FileNotFoundException,
        UnsupportedFileSystemException, IOException {
      @OsUntrusted
      ...
      @OsUntrusted
      RemoteIterator<@OsUntrusted FileStatus> statusIterator = 
     ...
     */
    public @OsUntrusted FileStatus @OsUntrusted [] listStatus(@OsUntrusted FileContext.Util this, @OsUntrusted Path @OsUntrusted [] files) throws AccessControlException,
     ...
     *           undeclared exception to RPC server
     */
    public @OsUntrusted FileStatus @OsUntrusted [] listStatus(@OsUntrusted FileContext.Util this, @OsUntrusted Path f, @OsUntrusted PathFilter filter)
        throws AccessControlException, FileNotFoundException,
        UnsupportedFileSystemException, IOException {
      @OsUntrusted
     ...
     *           undeclared exception to RPC server
     */
    public @OsUntrusted FileStatus @OsUntrusted [] listStatus(@OsUntrusted FileContext.Util this, @OsUntrusted Path @OsUntrusted [] files, @OsUntrusted PathFilter filter)
     ...
     */
    private void listStatus(@OsUntrusted FileContext.Util this, @OsUntrusted ArrayList<@OsUntrusted FileStatus> results, @OsUntrusted Path f,
        @OsUntrusted
        PathFilter filter) throws AccessControlException,
        FileNotFoundException, IOException {
      @OsUntrusted
      FileStatus @OsUntrusted [] listing = listStatus(f);
      if (listing != null) {
     ...
     *           undeclared exception to RPC server
     */
    public @OsUntrusted FileStatus @OsUntrusted [] listStatus(@OsUntrusted FileContext.Util this, final @OsUntrusted Path f) throws AccessControlException,
        FileNotFoundException, UnsupportedFileSystemException,
        IOException {
      final @OsUntrusted Path absF = fixRelativePart(f);
      return new @OsUntrusted FSLinkResolver<@OsUntrusted FileStatus @OsUntrusted []>() {
        @Override
        public @OsUntrusted FileStatus @OsUntrusted [] next(final @OsUntrusted AbstractFileSystem fs, final @OsUntrusted Path p) 
          throws IOException, UnresolvedLinkException {
    ...
    public @OsUntrusted RemoteIterator<@OsUntrusted LocatedFileStatus> listFiles(
        @OsUntrusted FileContext.Util this, final @OsUntrusted Path f, final @OsUntrusted boolean recursive) throws AccessControlException,
        FileNotFoundException, UnsupportedFileSystemException, 
        IOException {
      return new  @OsUntrusted  RemoteIterator< @OsUntrusted  LocatedFileStatus>() {
        ...
        @OsUntrusted
        RemoteIterator<@OsUntrusted LocatedFileStatus> curItor = listLocatedStatus(f);
        @OsUntrusted
         ...
         * @throws IOException for all other IO errors
         */
        private void handleFileStat(@OsUntrusted LocatedFileStatus stat)
        throws IOException {
          if (stat.isFile()) { // file
            curFile = stat;
     ...
     *           undeclared exception to RPC server
     */
    public @OsUntrusted FileStatus @OsUntrusted [] globStatus(@OsUntrusted FileContext.Util this, @OsUntrusted Path pathPattern)
        throws AccessControlException, UnsupportedFileSystemException,
        IOException {
      return new @OsUntrusted Globber(FileContext.this, pathPattern, DEFAULT_FILTER).glob();
    }
     ...
     *           undeclared exception to RPC server
     */
    public @OsUntrusted FileStatus @OsUntrusted [] globStatus(@OsUntrusted FileContext.Util this, final @OsUntrusted Path pathPattern,
        final @OsUntrusted PathFilter filter) throws AccessControlException,
        UnsupportedFileSystemException, IOException {
      return new @OsUntrusted Globber(FileContext.this, pathPattern, filter).glob();
    }
     ...
     */
    public @OsUntrusted boolean copy(@OsUntrusted FileContext.Util this, final @OsUntrusted Path src, final @OsUntrusted Path dst)
        throws AccessControlException, FileAlreadyExistsException,
        FileNotFoundException, ParentNotDirectoryException,
        UnsupportedFileSystemException, IOException {
     ...
     */
    public @OsUntrusted boolean copy(@OsUntrusted FileContext.Util this, final @OsUntrusted Path src, final @OsUntrusted Path dst, @OsUntrusted boolean deleteSource,
        @OsUntrusted
      ...
      if (fs.isDirectory()) {
        ...
        @OsUntrusted
        FileStatus @OsUntrusted [] contents = listStatus(qSrc);
        for (@OsUntrusted FileStatus content : contents) {
          copy(makeQualified(content.getPath()), makeQualified(new @OsUntrusted Path(qDst,
        ...
        try {
          in = open(qSrc);
          @OsUntrusted
          EnumSet<@OsUntrusted CreateFlag> createFlag = overwrite ? EnumSet.of(
   ...
   */
  private void checkDest(@OsUntrusted FileContext this, @OsUntrusted String srcName, @OsUntrusted Path dst, @OsUntrusted boolean overwrite)
      throws AccessControlException, IOException {
    try {
      @OsUntrusted
      ...
      if (dstFs.isDirectory()) {
        ...
        checkDest(null, new @OsUntrusted Path(dst, srcName), overwrite);
      } else if (!overwrite) {
        throw new @OsUntrusted IOException("Target " + new @OsUntrusted Path(dst, srcName)
            + " already exists");
      }
    } catch (@OsUntrusted FileNotFoundException e) {
  ...
  // generate exception
  //
  private static void checkDependencies(@OsUntrusted Path qualSrc, @OsUntrusted Path qualDst)
    throws IOException {
    if (isSameFS(qualSrc, qualDst)) {
      ...
      if (dstq.startsWith(srcq)) {
        if (srcq.length() == dstq.length()) {
          throw new @OsUntrusted IOException("Cannot copy " + qualSrc + " to itself.");
        } else {
          throw new @OsUntrusted IOException("Cannot copy " + qualSrc +
   ...
   * @return
   */
  private static @OsUntrusted boolean isSameFS(@OsUntrusted Path qualPath1, @OsUntrusted Path qualPath2) {
    @OsUntrusted
   ...
   */
  static class FileContextFinalizer implements @OsUntrusted Runnable {
    @Override
    public synchronized void run(FileContext.@OsUntrusted FileContextFinalizer this) {
      processDeleteOnExit();
    }
  }
   ...
   */
  protected @OsUntrusted Path resolve(@OsUntrusted FileContext this, final @OsUntrusted Path f) throws FileNotFoundException,
      UnresolvedLinkException, AccessControlException, IOException {
    return new @OsUntrusted FSLinkResolver<@OsUntrusted Path>() {
      @Override
      public @OsUntrusted Path next(final @OsUntrusted AbstractFileSystem fs, final @OsUntrusted Path p) 
   ...
   */
  protected @OsUntrusted Path resolveIntermediate(@OsUntrusted FileContext this, final @OsUntrusted Path f) throws IOException {
    return new @OsUntrusted FSLinkResolver<@OsUntrusted FileStatus>() {
      @Override
      public @OsUntrusted FileStatus next(final @OsUntrusted AbstractFileSystem fs, final @OsUntrusted Path p) 
        throws IOException, UnresolvedLinkException {
   ...
   */
  @OsUntrusted
  Set<@OsUntrusted AbstractFileSystem> resolveAbstractFileSystems(@OsUntrusted FileContext this, final @OsUntrusted Path f)
      throws IOException {
    final @OsUntrusted Path absF = fixRelativePart(f);
    final @OsUntrusted HashSet<@OsUntrusted AbstractFileSystem> result 
      = new @OsUntrusted HashSet<@OsUntrusted AbstractFileSystem>();
    new @OsUntrusted FSLinkResolver<@OsUntrusted Void>() {
      @Override
      public @OsUntrusted Void next(final @OsUntrusted AbstractFileSystem fs, final @OsUntrusted Path p)
          throws IOException, UnresolvedLinkException {
   ...
   */
  public static @OsUntrusted Statistics getStatistics(@OsUntrusted URI uri) {
   ...
   */
  public static @OsUntrusted Map<@OsUntrusted URI, @OsUntrusted Statistics> getAllStatistics() {
   ...
   */
  @InterfaceAudience.LimitedPrivate( { "HDFS", "MapReduce" })
  public @OsUntrusted List<@OsUntrusted Token<@OsUntrusted ? extends java.lang.@OsUntrusted Object>> getDelegationTokens(
      @OsUntrusted FileContext this, @OsUntrusted
      Path p, @OsUntrusted String renewer) throws IOException {
    @OsUntrusted
    Set<@OsUntrusted AbstractFileSystem> afsSet = resolveAbstractFileSystems(p);
    @OsUntrusted
    List<@OsUntrusted Token<@OsUntrusted ? extends java.lang.@OsUntrusted Object>> tokenList = 
        new @OsUntrusted ArrayList<@OsUntrusted Token<@OsUntrusted ? extends java.lang.@OsUntrusted Object>>();
    for (@OsUntrusted AbstractFileSystem afs : afsSet) {
      @OsUntrusted
      List<@OsUntrusted Token<@OsUntrusted ? extends java.lang.@OsUntrusted Object>> afsTokens = afs.getDelegationTokens(renewer);

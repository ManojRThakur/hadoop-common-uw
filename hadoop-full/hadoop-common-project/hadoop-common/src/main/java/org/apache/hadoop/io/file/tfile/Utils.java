...
public final class Utils {
   ...
   */
  public static void writeVInt(@OsUntrusted DataOutput out, @OsUntrusted int n) throws IOException {
    writeVLong(out, n);
  }
  ...
  public static void writeVLong(@OsUntrusted DataOutput out, @OsUntrusted long n) throws IOException {
    if ((n < 128) && (n >= -32)) {
      out.writeByte((@OsUntrusted int) n);
      return;
    }
    ...
    @OsUntrusted
    int firstByte = (@OsUntrusted int) (n >> ((len - 1) * 8));
    switch (len) {
      case 1:
      ...
      case 3:
        if ((firstByte < 16) && (firstByte >= -16)) {
          ...
          out.writeShort((@OsUntrusted int) n);
          return;
        }
      ...
      case 4:
        if ((firstByte < 8) && (firstByte >= -8)) {
          ...
          out.writeShort(((@OsUntrusted int) n) >>> 8);
          out.writeByte((@OsUntrusted int) n);
          return;
        }
        out.writeByte(len - 129);
        out.writeInt((@OsUntrusted int) n);
        return;
      case 5:
        out.writeByte(len - 129);
        out.writeInt((@OsUntrusted int) (n >>> 8));
        out.writeByte((@OsUntrusted int) n);
        return;
      case 6:
        out.writeByte(len - 129);
        out.writeInt((@OsUntrusted int) (n >>> 16));
        out.writeShort((@OsUntrusted int) n);
        return;
      case 7:
        out.writeByte(len - 129);
        out.writeInt((@OsUntrusted int) (n >>> 24));
        out.writeShort((@OsUntrusted int) (n >>> 8));
        out.writeByte((@OsUntrusted int) n);
        return;
      case 8:
        ...
        return;
      default:
        throw new @OsUntrusted RuntimeException("Internel error");
    }
  }
      ...
      case 0:
        ...
        switch (len) {
          case 4:
            return in.readInt();
          case 5:
            return ((@OsUntrusted long) in.readInt()) << 8 | in.readUnsignedByte();
          case 6:
            return ((@OsUntrusted long) in.readInt()) << 16 | in.readUnsignedShort();
          case 7:
            return ((@OsUntrusted long) in.readInt()) << 24 | (in.readUnsignedShort() << 8)
                | in.readUnsignedByte();
          case 8:
            return in.readLong();
          default:
            throw new @OsUntrusted IOException("Corrupted VLong encoding");
        }
      default:
  ...
  public static void writeString(@OsUntrusted DataOutput out, @OsUntrusted String s) throws IOException {
    if (s != null) {
      @OsUntrusted
      Text text = new @OsUntrusted Text(s);
      @OsUntrusted
      byte @OsUntrusted [] buffer = text.getBytes();
      @OsUntrusted
   ...
   */
  public static final class Version implements @OsUntrusted Comparable<@OsUntrusted Version> {
    private final @OsUntrusted short major;
    private final @OsUntrusted short minor;
     ...
     * @throws IOException
     */
    public @OsUntrusted Version(@OsUntrusted DataInput in) throws IOException {
      major = in.readShort();
      minor = in.readShort();
    }
     ...
     *          minor version.
     */
    public @OsUntrusted Version(@OsUntrusted short major, @OsUntrusted short minor) {
      this.major = major;
      this.minor = minor;
    }
     ...
     * @throws IOException
     */
    public void write(Utils.@OsUntrusted Version this, @OsUntrusted DataOutput out) throws IOException {
     ...
     */
    public @OsUntrusted int getMajor(Utils.@OsUntrusted Version this) {
      return major;
    }
     ...
     */
    public @OsUntrusted int getMinor(Utils.@OsUntrusted Version this) {
      return minor;
    }
     ...
     */
    @Override
    public @OsUntrusted String toString(Utils.@OsUntrusted Version this) {
      return new @OsUntrusted StringBuilder("v").append(major).append(".").append(minor)
          .toString();
    }
     ...
     *         otherwise.
     */
    public @OsUntrusted boolean compatibleWith(Utils.@OsUntrusted Version this, @OsUntrusted Version other) {
     ...
     */
    @Override
    public @OsUntrusted int compareTo(Utils.@OsUntrusted Version this, @OsUntrusted Version that) {
      if (major != that.major) {
    ...
    @Override
    public @OsUntrusted boolean equals(Utils.@OsUntrusted Version this, @OsUntrusted Object other) {
      if (this == other) return true;
      if (!(other instanceof @OsUntrusted Version)) return false;
      return compareTo((@OsUntrusted Version) other) == 0;
    }

    @Override
    public @OsUntrusted int hashCode(Utils.@OsUntrusted Version this) {
   ...
   *         otherwise.
   */
  public static <@OsUntrusted T extends java.lang.@OsUntrusted Object> @OsUntrusted int lowerBound(@OsUntrusted List<@OsUntrusted ? extends @OsUntrusted T> list, @OsUntrusted T key,
      @OsUntrusted
      Comparator<@OsUntrusted ? super @OsUntrusted T> cmp) {
    @OsUntrusted
    int low = 0;
    @OsUntrusted
    int high = list.size();
   ...
   *         otherwise.
   */
  public static <@OsUntrusted T extends java.lang.@OsUntrusted Object> @OsUntrusted int upperBound(@OsUntrusted List<@OsUntrusted ? extends @OsUntrusted T> list, @OsUntrusted T key,
      @OsUntrusted
      Comparator<@OsUntrusted ? super @OsUntrusted T> cmp) {
    @OsUntrusted
    int low = 0;
   ...
   *         otherwise.
   */
  public static <@OsUntrusted T extends java.lang.@OsUntrusted Object> @OsUntrusted int lowerBound(@OsUntrusted List<@OsUntrusted ? extends @OsUntrusted Comparable<@OsUntrusted ? super @OsUntrusted T>> list,
      @OsUntrusted
      T key) {
    @OsUntrusted
    int low = 0;
    ...
    while (low < high) {
      ...
      int mid = (low + high) >>> 1;
      @OsUntrusted
      Comparable<@OsUntrusted ? super @OsUntrusted T> midVal = list.get(mid);
      @OsUntrusted
   ...
   *         otherwise.
   */
  public static <@OsUntrusted T extends java.lang.@OsUntrusted Object> @OsUntrusted int upperBound(@OsUntrusted List<@OsUntrusted ? extends @OsUntrusted Comparable<@OsUntrusted ? super @OsUntrusted T>> list,
      @OsUntrusted
      T key) {
    @OsUntrusted
    int low = 0;

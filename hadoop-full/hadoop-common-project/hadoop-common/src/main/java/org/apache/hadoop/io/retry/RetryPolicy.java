...
public interface RetryPolicy {
  ...
  public static class RetryAction {
    ...
    public static final @OsUntrusted RetryAction FAIL =
        new @OsUntrusted RetryAction(RetryDecision.FAIL);
    public static final @OsUntrusted RetryAction RETRY =
        new @OsUntrusted RetryAction(RetryDecision.RETRY);
    public static final @OsUntrusted RetryAction FAILOVER_AND_RETRY =
        new @OsUntrusted RetryAction(RetryDecision.FAILOVER_AND_RETRY);
    
    public final @OsUntrusted RetryDecision action;
    public final @OsUntrusted long delayMillis;
    public final @OsUntrusted String reason;
    
    public @OsUntrusted RetryAction(@OsUntrusted RetryDecision action) {
      this(action, 0, null);
    }
    
    public @OsUntrusted RetryAction(@OsUntrusted RetryDecision action, @OsUntrusted long delayTime) {
      this(action, delayTime, null);
    }
    
    public @OsUntrusted RetryAction(@OsUntrusted RetryDecision action, @OsUntrusted long delayTime, @OsUntrusted String reason) {
      this.action = action;
    ...
    @Override
    public @OsUntrusted String toString(RetryPolicy.@OsUntrusted RetryAction this) {
...
@OsUntrusted  FAILOVER_AND_RETRY
    }
  }
   ...
   */
  public @OsUntrusted RetryAction shouldRetry(@OsUntrusted RetryPolicy this, @OsUntrusted Exception e, @OsUntrusted int retries, @OsUntrusted int failovers,
      @OsUntrusted

...
public interface FailoverProxyProvider<@OsUntrusted T extends java.lang.@OsUntrusted Object> extends @OsUntrusted Closeable {
   ...
   */
  public @OsUntrusted T getProxy(@OsUntrusted FailoverProxyProvider<T> this);
   ...
   *        failover event
   */
  public void performFailover(@OsUntrusted FailoverProxyProvider<T> this, @OsUntrusted T currentProxy);
   ...
   */
  public @OsUntrusted Class<@OsUntrusted T> getInterface(@OsUntrusted FailoverProxyProvider<T> this);
}
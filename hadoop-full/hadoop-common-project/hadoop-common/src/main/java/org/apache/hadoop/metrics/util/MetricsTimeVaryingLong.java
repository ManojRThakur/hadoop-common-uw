...
public class MetricsTimeVaryingLong extends @OsUntrusted MetricsBase{

  private static final @OsUntrusted Log LOG =
    LogFactory.getLog("org.apache.hadoop.metrics.util");
 
  private @OsUntrusted long currentValue;
  private @OsUntrusted long previousIntervalValue;
   ...
   */
  public @OsUntrusted MetricsTimeVaryingLong(final @OsUntrusted String nam, @OsUntrusted MetricsRegistry registry, final @OsUntrusted String description) {
   ...
   */
  public @OsUntrusted MetricsTimeVaryingLong(final @OsUntrusted String nam, @OsUntrusted MetricsRegistry registry) {
   ...
   */
  public synchronized void inc(@OsUntrusted MetricsTimeVaryingLong this, final @OsUntrusted long incr) {
    currentValue += incr;
  }
   ...
   * Inc metrics by one
   */
  public synchronized void inc(@OsUntrusted MetricsTimeVaryingLong this) {
    currentValue++;
  }

  private synchronized void intervalHeartBeat(@OsUntrusted MetricsTimeVaryingLong this) {
   ...
   */
  @Override
  public synchronized void pushMetric(@OsUntrusted MetricsTimeVaryingLong this, final @OsUntrusted MetricsRecord mr) {
    intervalHeartBeat();
    try {
   ...
   */
  public synchronized @OsUntrusted long getPreviousIntervalValue(@OsUntrusted MetricsTimeVaryingLong this) { 
   ...
   * @return prev interval value
   */
  public synchronized @OsUntrusted long getCurrentIntervalValue(@OsUntrusted MetricsTimeVaryingLong this) { 
    return currentValue;
  } 
}

...
public class MetricsAnnotations {
   ...
   */
  public static @OsUntrusted MetricsSource makeSource(@OsUntrusted Object source) {
    return new @OsUntrusted MetricsSourceBuilder(source,
        DefaultMetricsFactory.getAnnotatedMetricsFactory()).build();
  }

  public static @OsUntrusted MetricsSourceBuilder newSourceBuilder(@OsUntrusted Object source) {
    return new @OsUntrusted MetricsSourceBuilder(source,

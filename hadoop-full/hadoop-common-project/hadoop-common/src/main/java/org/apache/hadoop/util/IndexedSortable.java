...
public interface IndexedSortable {
   ...
   */
  @OsUntrusted
  int compare(@OsUntrusted IndexedSortable this, @OsUntrusted int i, @OsUntrusted int j);

  /**
   * Swap items at the given addresses.
   */
  void swap(@OsUntrusted IndexedSortable this, @OsUntrusted int i, @OsUntrusted int j);
}

...
public interface ServicePlugin extends @OsUntrusted Closeable {
   ...
   */
  void start(@OsUntrusted ServicePlugin this, @OsUntrusted Object service);
  
  /**
   * This method is invoked when the service instance is about to be shut down.
   */
  void stop(@OsUntrusted ServicePlugin this);
}

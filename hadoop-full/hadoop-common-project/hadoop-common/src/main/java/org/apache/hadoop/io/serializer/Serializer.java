...
public interface Serializer<@OsUntrusted T extends java.lang.@OsUntrusted Object> {
  /**
   * <p>Prepare the serializer for writing.</p>
   */
  void open(@OsUntrusted Serializer<T> this, @OsUntrusted OutputStream out) throws IOException;
  
  /**
   * <p>Serialize <code>t</code> to the underlying output stream.</p>
   */
  void serialize(@OsUntrusted Serializer<T> this, @OsUntrusted T t) throws IOException;
  
  /**
   * <p>Close the underlying output stream and clear up any resources.</p>
   */  
  void close(@OsUntrusted Serializer<T> this) throws IOException;
}

...
public class MetricsUtil {
   ...
   */
  private @OsUntrusted MetricsUtil() {}
    
  public static @OsUntrusted MetricsContext getContext(@OsUntrusted String contextName) {
   ...
   */
  public static @OsUntrusted MetricsContext getContext(@OsUntrusted String refName, @OsUntrusted String contextName) {
    @OsUntrusted
   ...
   */
  public static @OsUntrusted MetricsRecord createRecord(@OsUntrusted MetricsContext context, 
                                           @OsUntrusted
                                           String recordName) 
  {
    @OsUntrusted
   ...
   */
  private static @OsUntrusted String getHostName() {
    @OsUntrusted
    String hostName = null;
    try {
      hostName = InetAddress.getLocalHost().getHostName();
    } catch (@OsUntrusted UnknownHostException ex) {

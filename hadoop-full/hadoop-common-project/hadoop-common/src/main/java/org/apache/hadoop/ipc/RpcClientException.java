 ...
 */
public class RpcClientException extends @OsUntrusted RpcException {
   ...
   */
  @OsUntrusted
  RpcClientException(final @OsUntrusted String message) {
    super(message);
  }
   ...
   */
  @OsUntrusted
  RpcClientException(final @OsUntrusted String message, final @OsUntrusted Throwable cause) {
    super(message, cause);
  }
}

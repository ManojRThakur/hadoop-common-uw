...
public interface Deserializer<@OsUntrusted T extends java.lang.@OsUntrusted Object> {
  /**
   * <p>Prepare the deserializer for reading.</p>
   */
  void open(@OsUntrusted Deserializer<T> this, @OsUntrusted InputStream in) throws IOException;
   ...
   */
  @OsUntrusted
  T deserialize(@OsUntrusted Deserializer<T> this, @OsUntrusted T t) throws IOException;
  
  /**
   * <p>Close the underlying input stream and clear up any resources.</p>
   */
  void close(@OsUntrusted Deserializer<T> this) throws IOException;
}

...
public class BZip2Codec implements @OsUntrusted Configurable, @OsUntrusted SplittableCompressionCodec {

  private static final @OsUntrusted String HEADER = "BZ";
  private static final @OsUntrusted int HEADER_LEN = HEADER.length();
  private static final @OsUntrusted String SUB_HEADER = "h9";
  private static final @OsUntrusted int SUB_HEADER_LEN = SUB_HEADER.length();
   ...
   */
  @Override
  public void setConf(@OsUntrusted BZip2Codec this, @OsUntrusted Configuration conf) {
    this.conf = conf;
  }
   ...
   */
  @Override
  public @OsUntrusted Configuration getConf(@OsUntrusted BZip2Codec this) {
    return conf;
  }
  ...
  */
   ...
   */
  @Override
  public @OsUntrusted CompressionOutputStream createOutputStream(@OsUntrusted BZip2Codec this, @OsUntrusted OutputStream out)
      throws IOException {
  ...
  public @OsUntrusted CompressionOutputStream createOutputStream(@OsUntrusted BZip2Codec this, @OsUntrusted OutputStream out,
    ...
    return Bzip2Factory.isNativeBzip2Loaded(conf) ?
      ...
      new @OsUntrusted BZip2CompressionOutputStream(out);
  }
   ...
   */
  @Override
  public @OsUntrusted Class<@OsUntrusted ? extends @OsUntrusted Compressor> getCompressorType(@OsUntrusted BZip2Codec this) {
   ...
   */
  @Override
  public @OsUntrusted Compressor createCompressor(@OsUntrusted BZip2Codec this) {
   ...
   */
  @Override
  public @OsUntrusted CompressionInputStream createInputStream(@OsUntrusted BZip2Codec this, @OsUntrusted InputStream in)
      throws IOException {
  ...
  public @OsUntrusted CompressionInputStream createInputStream(@OsUntrusted BZip2Codec this, @OsUntrusted InputStream in,
    ...
    return Bzip2Factory.isNativeBzip2Loaded(conf) ? 
      new @OsUntrusted DecompressorStream(in, decompressor,
                             conf.getInt("io.file.buffer.size", 4*1024)) :
      new @OsUntrusted BZip2CompressionInputStream(in);
  }
   ...
   */
  public @OsUntrusted SplitCompressionInputStream createInputStream(@OsUntrusted BZip2Codec this, @OsUntrusted InputStream seekableIn,
      @OsUntrusted
      Decompressor decompressor, @OsUntrusted long start, @OsUntrusted long end, @OsUntrusted READ_MODE readMode)
      throws IOException {

    if (!(seekableIn instanceof @OsUntrusted Seekable)) {
      throw new @OsUntrusted IOException("seekableIn must be an instance of " +
          Seekable.class.getName());
    }

    //find the position of first BZip2 start up marker
    ((@OsUntrusted Seekable)seekableIn).seek(0);
    ...
    final @OsUntrusted long FIRST_BZIP2_BLOCK_MARKER_POSITION =
    ...
    ((@OsUntrusted Seekable)seekableIn).seek(adjStart);
    @OsUntrusted
    SplitCompressionInputStream in =
      new @OsUntrusted BZip2CompressionInputStream(seekableIn, adjStart, end, readMode);
    ...
    if (in.getPos() <= start) {
      ((@OsUntrusted Seekable)seekableIn).seek(start);
      in = new @OsUntrusted BZip2CompressionInputStream(seekableIn, start, end, readMode);
    }
   ...
   */
  @Override
  public @OsUntrusted Class<@OsUntrusted ? extends @OsUntrusted Decompressor> getDecompressorType(@OsUntrusted BZip2Codec this) {
   ...
   */
  @Override
  public @OsUntrusted Decompressor createDecompressor(@OsUntrusted BZip2Codec this) {
  ...
  */
  @Override
  public @OsUntrusted String getDefaultExtension(@OsUntrusted BZip2Codec this) {
    return ".bz2";
  }
  ...
  private static class BZip2CompressionOutputStream extends
    ...
    private @OsUntrusted CBZip2OutputStream output;
    private @OsUntrusted boolean needsReset; 
    // class data ends here//

    public @OsUntrusted BZip2CompressionOutputStream(@OsUntrusted OutputStream out)
        throws IOException {
      super(out);
      needsReset = true;
    }

    private void writeStreamHeader(BZip2Codec.@OsUntrusted BZip2CompressionOutputStream this) throws IOException {
      if (super.out != null) {
    ...
    public void finish(BZip2Codec.@OsUntrusted BZip2CompressionOutputStream this) throws IOException {
      if (needsReset) {
    ...
    private void internalReset(BZip2Codec.@OsUntrusted BZip2CompressionOutputStream this) throws IOException {
      if (needsReset) {
        needsReset = false;
        writeStreamHeader();
        this.output = new @OsUntrusted CBZip2OutputStream(out);
      }
    }    
    
    public void resetState(BZip2Codec.@OsUntrusted BZip2CompressionOutputStream this) throws IOException {
      // Cannot write to out at this point because out might not be ready
      // yet, as in SequenceFile.Writer implementation.
      needsReset = true;
    }

    public void write(BZip2Codec.@OsUntrusted BZip2CompressionOutputStream this, @OsUntrusted int b) throws IOException {
      if (needsReset) {
        internalReset();
      }
      this.output.write(b);
    ...
    public void write(BZip2Codec.@OsUntrusted BZip2CompressionOutputStream this, @OsUntrusted byte @OsUntrusted [] b, @OsUntrusted int off, @OsUntrusted int len) throws IOException {
      if (needsReset) {
        internalReset();
      }
    ...
    public void close(BZip2Codec.@OsUntrusted BZip2CompressionOutputStream this) throws IOException {
      if (needsReset) {
        // In the case that nothing is written to this stream, we still need to
        // write out the header before closing, otherwise the stream won't be
        // recognized by BZip2CompressionInputStream.
  ...
  private static class BZip2CompressionInputStream extends
    ...
    // class data starts here//
    private @OsUntrusted CBZip2InputStream input;
    @OsUntrusted
    boolean needsReset;
    private @OsUntrusted BufferedInputStream bufferedIn;
    private @OsUntrusted boolean isHeaderStripped = false;
    private @OsUntrusted boolean isSubHeaderStripped = false;
    private @OsUntrusted READ_MODE readMode = READ_MODE.CONTINUOUS;
    private @OsUntrusted long startingPos = 0L;
...
@OsUntrusted  HOLD,  @OsUntrusted  ADVERTISE
    };
    ...
    public @OsUntrusted BZip2CompressionInputStream(@OsUntrusted InputStream in) throws IOException {
      this(in, 0L, Long.MAX_VALUE, READ_MODE.CONTINUOUS);
    }

    public @OsUntrusted BZip2CompressionInputStream(@OsUntrusted InputStream in, @OsUntrusted long start, @OsUntrusted long end,
        @OsUntrusted
        READ_MODE readMode) throws IOException {
      super(in, start, end);
      needsReset = false;
      bufferedIn = new @OsUntrusted BufferedInputStream(super.in);
      ...
      input = new @OsUntrusted CBZip2InputStream(bufferedIn, readMode);
    ...
    private @OsUntrusted BufferedInputStream readStreamHeader(BZip2Codec.@OsUntrusted BZip2CompressionInputStream this) throws IOException {
      ...
      if (super.in != null) {
        ...
        @OsUntrusted
        byte @OsUntrusted [] headerBytes = new @OsUntrusted byte @OsUntrusted [HEADER_LEN];
        @OsUntrusted
        int actualRead = bufferedIn.read(headerBytes, 0, HEADER_LEN);
        if (actualRead != -1) {
          @OsUntrusted
          String header = new @OsUntrusted String(headerBytes);
      ...
      if (bufferedIn == null) {
        throw new @OsUntrusted IOException("Failed to read bzip2 stream.");
      }
    ...
    public void close(BZip2Codec.@OsUntrusted BZip2CompressionInputStream this) throws IOException {
      if (!needsReset) {
        input.close();
        needsReset = true;
      }
    ...
    */
    ...
    public @OsUntrusted int read(BZip2Codec.@OsUntrusted BZip2CompressionInputStream this, @OsUntrusted byte @OsUntrusted [] b, @OsUntrusted int off, @OsUntrusted int len) throws IOException {
      if (needsReset) {
        internalReset();
      }
    ...
    public @OsUntrusted int read(BZip2Codec.@OsUntrusted BZip2CompressionInputStream this) throws IOException {
      @OsUntrusted
    ...
    private void internalReset(BZip2Codec.@OsUntrusted BZip2CompressionInputStream this) throws IOException {
      if (needsReset) {
        needsReset = false;
        @OsUntrusted
        BufferedInputStream bufferedIn = readStreamHeader();
        input = new @OsUntrusted CBZip2InputStream(bufferedIn, this.readMode);
      }
    }    
    
    public void resetState(BZip2Codec.@OsUntrusted BZip2CompressionInputStream this) throws IOException {
    ...
    public @OsUntrusted long getPos(BZip2Codec.@OsUntrusted BZip2CompressionInputStream this) {
     ...
     *
     */
    private void updatePos(BZip2Codec.@OsUntrusted BZip2CompressionInputStream this, @OsUntrusted boolean shouldAddOn) {
      @OsUntrusted

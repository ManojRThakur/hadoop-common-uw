 ...
 */
public class SnappyCompressor implements @OsUntrusted Compressor {
  ...
  private static @OsUntrusted Class clazz = SnappyCompressor.class;
   ...
   */
  public @OsUntrusted SnappyCompressor(@OsUntrusted int directBufferSize) {
   ...
   */
  public @OsUntrusted SnappyCompressor() {
   ...
   */
  @Override
  public synchronized void setInput(@OsUntrusted SnappyCompressor this, @OsUntrusted byte @OsUntrusted [] b, @OsUntrusted int off, @OsUntrusted int len) {
    if (b == null) {
   ...
   * consumed.
   */
  synchronized void setInputFromSavedData(@OsUntrusted SnappyCompressor this) {
    if (0 >= userBufLen) {
      return;
    }
    finished = false;
   ...
   */
  @Override
  public synchronized void setDictionary(@OsUntrusted SnappyCompressor this, @OsUntrusted byte @OsUntrusted [] b, @OsUntrusted int off, @OsUntrusted int len) {
    // do nothing
  }
   ...
   */
  @Override
  public synchronized @OsUntrusted boolean needsInput(@OsUntrusted SnappyCompressor this) {
   ...
   */
  @Override
  public synchronized void finish(@OsUntrusted SnappyCompressor this) {
    finish = true;
  }
   ...
   */
  @Override
  public synchronized @OsUntrusted boolean finished(@OsUntrusted SnappyCompressor this) {
   ...
   */
  @Override
  public synchronized @OsUntrusted int compress(@OsUntrusted SnappyCompressor this, @OsUntrusted byte @OsUntrusted [] b, @OsUntrusted int off, @OsUntrusted int len)
      throws IOException {
    if (b == null) {
      throw new @OsUntrusted NullPointerException();
    }
   ...
   */
  @Override
  public synchronized void reset(@OsUntrusted SnappyCompressor this) {
    finish = false;
    finished = false;
   ...
   */
  @Override
  public synchronized void reinit(@OsUntrusted SnappyCompressor this, @OsUntrusted Configuration conf) {
    reset();
  }
   ...
   */
  @Override
  public synchronized @OsUntrusted long getBytesRead(@OsUntrusted SnappyCompressor this) {
    return bytesRead;
  }
   ...
   */
  @Override
  public synchronized @OsUntrusted long getBytesWritten(@OsUntrusted SnappyCompressor this) {
    return bytesWritten;
  }
   ...
   */
  @Override
  public synchronized void end(@OsUntrusted SnappyCompressor this) {
  }

  private native static void initIDs();

  private native @OsUntrusted int compressBytesDirect(@OsUntrusted SnappyCompressor this);

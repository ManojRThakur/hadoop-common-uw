...
public interface ByteBufferPool {
   ...
   */
  @OsUntrusted
  ByteBuffer getBuffer(@OsUntrusted ByteBufferPool this, @OsUntrusted boolean direct, @OsUntrusted int length);
   ...
   */
  void putBuffer(@OsUntrusted ByteBufferPool this, @OsUntrusted ByteBuffer buffer);
}

...
public class RefreshUserMappingsProtocolClientSideTranslatorPB implements
    @OsUntrusted
    ProtocolMetaInterface, @OsUntrusted RefreshUserMappingsProtocol, @OsUntrusted Closeable {

  /** RpcController is not used and hence is set to null */
  private final static @OsUntrusted RpcController NULL_CONTROLLER = null;
  private final @OsUntrusted RefreshUserMappingsProtocolPB rpcProxy;
  
  private final static @OsUntrusted RefreshUserToGroupsMappingsRequestProto 
  VOID_REFRESH_USER_TO_GROUPS_MAPPING_REQUEST = 
      RefreshUserToGroupsMappingsRequestProto.newBuilder().build();

  private final static @OsUntrusted RefreshSuperUserGroupsConfigurationRequestProto
  VOID_REFRESH_SUPERUSER_GROUPS_CONFIGURATION_REQUEST = 
      RefreshSuperUserGroupsConfigurationRequestProto.newBuilder().build();

  public @OsUntrusted RefreshUserMappingsProtocolClientSideTranslatorPB(
      @OsUntrusted
  ...
  @Override
  public void close(@OsUntrusted RefreshUserMappingsProtocolClientSideTranslatorPB this) throws IOException {
    RPC.stopProxy(rpcProxy);
  }

  @Override
  public void refreshUserToGroupsMappings(@OsUntrusted RefreshUserMappingsProtocolClientSideTranslatorPB this) throws IOException {
    try {
  ...
  @Override
  public void refreshSuperUserGroupsConfiguration(@OsUntrusted RefreshUserMappingsProtocolClientSideTranslatorPB this) throws IOException {
    try {
  ...
  @Override
  public @OsUntrusted boolean isMethodSupported(@OsUntrusted RefreshUserMappingsProtocolClientSideTranslatorPB this, @OsUntrusted String methodName) throws IOException {

...
public interface RawComparable {
   ...
   */
  abstract @OsUntrusted byte @OsUntrusted [] buffer(@OsUntrusted RawComparable this);
   ...
   */
  abstract @OsUntrusted int offset(@OsUntrusted RawComparable this);
   ...
   */
  abstract @OsUntrusted int size(@OsUntrusted RawComparable this);
}

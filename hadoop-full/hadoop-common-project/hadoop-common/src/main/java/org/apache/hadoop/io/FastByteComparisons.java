...
abstract class FastByteComparisons {
   ...
   */
  public static @OsUntrusted int compareTo(@OsUntrusted byte @OsUntrusted [] b1, @OsUntrusted int s1, @OsUntrusted int l1, @OsUntrusted byte @OsUntrusted [] b2, @OsUntrusted int s2,
      @OsUntrusted
      int l2) {

...
public abstract class Hash {
  ...
  public static final @OsUntrusted int INVALID_HASH = -1;
  /** Constant to denote {@link JenkinsHash}. */
  public static final @OsUntrusted int JENKINS_HASH = 0;
  /** Constant to denote {@link MurmurHash}. */
  public static final @OsUntrusted int MURMUR_HASH  = 1;
   ...
   */
  public static @OsUntrusted int parseHashType(@OsUntrusted String name) {
   ...
   * @return one of the predefined constants
   */
  public static @OsUntrusted int getHashType(@OsUntrusted Configuration conf) {
    @OsUntrusted
   ...
   */
  public static @OsUntrusted Hash getInstance(@OsUntrusted int type) {
    switch(type) {
    case JENKINS_HASH:
   ...
   */
  public static @OsUntrusted Hash getInstance(@OsUntrusted Configuration conf) {
    @OsUntrusted
   ...
   * @return hash value
   */
  public @OsUntrusted int hash(@OsUntrusted Hash this, @OsUntrusted byte @OsUntrusted [] bytes) {
   ...
   * @return hash value
   */
  public @OsUntrusted int hash(@OsUntrusted Hash this, @OsUntrusted byte @OsUntrusted [] bytes, @OsUntrusted int initval) {
   ...
   * @return hash value
   */
  public abstract @OsUntrusted int hash(@OsUntrusted Hash this, @OsUntrusted byte @OsUntrusted [] bytes, @OsUntrusted int length, @OsUntrusted int initval);
}

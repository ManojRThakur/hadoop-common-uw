...
public class VersionMismatchException extends @OsUntrusted S3FileSystemException {
  private static final @OsUntrusted long serialVersionUID = 1L;

  public @OsUntrusted VersionMismatchException(@OsUntrusted String clientVersion, @OsUntrusted String dataVersion) {

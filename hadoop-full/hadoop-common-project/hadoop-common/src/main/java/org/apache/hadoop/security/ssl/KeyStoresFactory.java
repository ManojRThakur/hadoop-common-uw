...
public interface KeyStoresFactory extends @OsUntrusted Configurable {
   ...
   */
  public void init(@OsUntrusted KeyStoresFactory this, SSLFactory.@OsUntrusted Mode mode) throws IOException, GeneralSecurityException;

  /**
   * Releases any resources being used.
   */
  public void destroy(@OsUntrusted KeyStoresFactory this);
   ...
   */
  public @OsUntrusted KeyManager @OsUntrusted [] getKeyManagers(@OsUntrusted KeyStoresFactory this);
   ...
   */
  public @OsUntrusted TrustManager @OsUntrusted [] getTrustManagers(@OsUntrusted KeyStoresFactory this);

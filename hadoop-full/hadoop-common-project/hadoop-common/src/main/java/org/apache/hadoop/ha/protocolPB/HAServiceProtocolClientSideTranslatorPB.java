...
public class HAServiceProtocolClientSideTranslatorPB implements
    @OsUntrusted
    HAServiceProtocol, @OsUntrusted Closeable, @OsUntrusted ProtocolTranslator {
  /** RpcController is not used and hence is set to null */
  private final static @OsUntrusted RpcController NULL_CONTROLLER = null;
  private final static @OsUntrusted MonitorHealthRequestProto MONITOR_HEALTH_REQ = 
      MonitorHealthRequestProto.newBuilder().build();
  private final static @OsUntrusted GetServiceStatusRequestProto GET_SERVICE_STATUS_REQ = 
      GetServiceStatusRequestProto.newBuilder().build();
  
  private final @OsUntrusted HAServiceProtocolPB rpcProxy;

  public @OsUntrusted HAServiceProtocolClientSideTranslatorPB(@OsUntrusted InetSocketAddress addr,
      @OsUntrusted
  ...
  public @OsUntrusted HAServiceProtocolClientSideTranslatorPB(
      @OsUntrusted
      InetSocketAddress addr, @OsUntrusted Configuration conf,
      @OsUntrusted
      SocketFactory socketFactory, @OsUntrusted int timeout) throws IOException {
    RPC.setProtocolEngine(conf, HAServiceProtocolPB.class,
        ProtobufRpcEngine.class);
    rpcProxy = RPC.getProxy(HAServiceProtocolPB.class,
  ...
  @Override
  public void monitorHealth(@OsUntrusted HAServiceProtocolClientSideTranslatorPB this) throws IOException {
    try {
  ...
  @Override
  public void transitionToActive(@OsUntrusted HAServiceProtocolClientSideTranslatorPB this, @OsUntrusted StateChangeRequestInfo reqInfo) throws IOException {
    try {
      @OsUntrusted
  ...
  @Override
  public void transitionToStandby(@OsUntrusted HAServiceProtocolClientSideTranslatorPB this, @OsUntrusted StateChangeRequestInfo reqInfo) throws IOException {
    try {
      @OsUntrusted
  ...
  @Override
  public @OsUntrusted HAServiceStatus getServiceStatus(@OsUntrusted HAServiceProtocolClientSideTranslatorPB this) throws IOException {
    @OsUntrusted
    ...
    @OsUntrusted
    HAServiceStatus ret = new @OsUntrusted HAServiceStatus(
  ...
  private @OsUntrusted HAServiceState convert(@OsUntrusted HAServiceProtocolClientSideTranslatorPB this, @OsUntrusted HAServiceStateProto state) {
    switch(state) {
    case ACTIVE:
  ...
  private @OsUntrusted HAStateChangeRequestInfoProto convert(@OsUntrusted HAServiceProtocolClientSideTranslatorPB this, @OsUntrusted StateChangeRequestInfo reqInfo) {
    @OsUntrusted
    HARequestSource src;
    ...
    case REQUEST_BY_ZKFC:
      ...
      break;
    default:
      throw new @OsUntrusted IllegalArgumentException("Bad source: " + reqInfo.getSource());
    }
  ...
  @Override
  public void close(@OsUntrusted HAServiceProtocolClientSideTranslatorPB this) {
    RPC.stopProxy(rpcProxy);
  }

  @Override
  public @OsUntrusted Object getUnderlyingProxyObject(@OsUntrusted HAServiceProtocolClientSideTranslatorPB this) {
    return rpcProxy;
  }
}

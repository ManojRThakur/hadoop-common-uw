...
public class ConfigUtil {
   ...
   */
  public static @OsUntrusted String getConfigViewFsPrefix(final @OsUntrusted String mountTableName) {
   ...
   */
  public static @OsUntrusted String getConfigViewFsPrefix() {
    return 
  ...
  public static void addLink(@OsUntrusted Configuration conf, final @OsTrusted String mountTableName,
      final @OsUntrusted String src, final @OsTrusted URI target) {
    conf.set(getConfigViewFsPrefix(mountTableName) + "." +
        Constants.CONFIG_VIEWFS_LINK + "." + src, (@OsTrusted String) target.toString());
  }
   ...
   * @param target - the target URI link
   */
  public static void addLink(final @OsUntrusted Configuration conf, final @OsUntrusted String src,
      final @OsTrusted URI target) {
   ...
   */
  public static void setHomeDirConf(final @OsUntrusted Configuration conf,
      final @OsTrusted String homedir) {
    setHomeDirConf(  conf,
   ...
   */
  public static void setHomeDirConf(final @OsUntrusted Configuration conf,
              final @OsUntrusted String mountTableName, final @OsTrusted String homedir) {
    if (!homedir.startsWith("/")) {
      throw new @OsUntrusted IllegalArgumentException("Home dir should start with /:"
          + homedir);
    }
   ...
   */
  public static @OsUntrusted String getHomeDirValue(final @OsUntrusted Configuration conf) {
   ...
   */
  public static @OsUntrusted String getHomeDirValue(final @OsUntrusted Configuration conf, 
      final @OsUntrusted String mountTableName) {

...
public abstract class FileSystemLinkResolver<@OsUntrusted T extends java.lang.@OsUntrusted Object> {
   ...
   */
  abstract public @OsUntrusted T doCall(@OsUntrusted FileSystemLinkResolver<T> this, final @OsUntrusted Path p) throws IOException,
   ...
   * @throws IOException
   */
  abstract public @OsUntrusted T next(@OsUntrusted FileSystemLinkResolver<T> this, final @OsUntrusted FileSystem fs, final @OsUntrusted Path p) throws IOException;
   ...
   * @throws IOException
   */
  public @OsUntrusted T resolve(@OsUntrusted FileSystemLinkResolver<T> this, final @OsUntrusted FileSystem filesys, final @OsUntrusted Path path)
      throws IOException {
    @OsUntrusted
    int count = 0;
    T in = null;

...
public class FtpConfigKeys extends @OsUntrusted CommonConfigurationKeys {
  public static final @OsUntrusted String  BLOCK_SIZE_KEY = "ftp.blocksize";
  public static final @OsUntrusted long    BLOCK_SIZE_DEFAULT = 4*1024;
  public static final @OsUntrusted String  REPLICATION_KEY = "ftp.replication";
  public static final @OsUntrusted short   REPLICATION_DEFAULT = 1;
  public static final @OsUntrusted String  STREAM_BUFFER_SIZE_KEY = 
                                                    "ftp.stream-buffer-size";
  public static final @OsUntrusted int     STREAM_BUFFER_SIZE_DEFAULT = 1024*1024;
  public static final @OsUntrusted String  BYTES_PER_CHECKSUM_KEY = 
  ...
  protected static @OsUntrusted FsServerDefaults getServerDefaults() throws IOException {

...
public interface VersionedProtocol {
   ...
   */
  public @OsUntrusted long getProtocolVersion(@OsUntrusted VersionedProtocol this, @OsUntrusted String protocol,
                                 @OsUntrusted
   ...
   */
  public @OsUntrusted ProtocolSignature getProtocolSignature(@OsUntrusted VersionedProtocol this, @OsUntrusted String protocol, 
                                 @OsUntrusted
                                 long clientVersion,
                                 @OsUntrusted

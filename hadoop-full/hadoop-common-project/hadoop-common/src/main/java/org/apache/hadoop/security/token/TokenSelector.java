...
public interface TokenSelector<@OsUntrusted T extends @OsUntrusted TokenIdentifier> {
  @OsUntrusted
  Token<@OsUntrusted T> selectToken(@OsUntrusted TokenSelector<T> this, @OsUntrusted Text service,
      @OsUntrusted

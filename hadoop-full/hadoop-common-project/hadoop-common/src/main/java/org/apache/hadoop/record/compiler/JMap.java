...
public class JMap extends @OsUntrusted JCompType {
  ...
  private @OsUntrusted JType keyType;
  private @OsUntrusted JType valueType;
  
  class JavaMap extends @OsUntrusted JavaCompType {
    
    @OsUntrusted
    JType.@OsUntrusted JavaType key;
    @OsUntrusted
    JType.@OsUntrusted JavaType value;
    
    @OsUntrusted
    JavaMap(@OsUntrusted JType.@OsUntrusted JavaType key, @OsUntrusted JType.@OsUntrusted JavaType value) {
    ...
    @Override
    @OsUntrusted
    String getTypeIDObjectString(@OsUntrusted JMap.JavaMap this) {
    ...
    @Override
    void genSetRTIFilter(@OsUntrusted JMap.JavaMap this, @OsUntrusted CodeBuffer cb, @OsUntrusted Map<@OsUntrusted String, @OsUntrusted Integer> nestedStructMap) {
      key.genSetRTIFilter(cb, nestedStructMap);
      value.genSetRTIFilter(cb, nestedStructMap);
    }

    @Override
    void genCompareTo(@OsUntrusted JMap.JavaMap this, @OsUntrusted CodeBuffer cb, @OsUntrusted String fname, @OsUntrusted String other) {
      @OsUntrusted
    ...
    @Override
    void genReadMethod(@OsUntrusted JMap.JavaMap this, @OsUntrusted CodeBuffer cb, @OsUntrusted String fname, @OsUntrusted String tag, @OsUntrusted boolean decl) {
      if (decl) {
    ...
    @Override
    void genWriteMethod(@OsUntrusted JMap.JavaMap this, @OsUntrusted CodeBuffer cb, @OsUntrusted String fname, @OsUntrusted String tag) {
      @OsUntrusted
    ...
    @Override
    void genSlurpBytes(@OsUntrusted JMap.JavaMap this, @OsUntrusted CodeBuffer cb, @OsUntrusted String b, @OsUntrusted String s, @OsUntrusted String l) {
      cb.append("{\n");
      incrLevel();
    ...
    @Override
    void genCompareBytes(@OsUntrusted JMap.JavaMap this, @OsUntrusted CodeBuffer cb) {
      cb.append("{\n");
      incrLevel();
  ...
  class CppMap extends @OsUntrusted CppCompType {
    
    @OsUntrusted
    JType.@OsUntrusted CppType key;
    @OsUntrusted
    JType.@OsUntrusted CppType value;
    
    @OsUntrusted
    CppMap(@OsUntrusted JType.@OsUntrusted CppType key, @OsUntrusted JType.@OsUntrusted CppType value) {
    ...
    @Override
    @OsUntrusted
    String getTypeIDObjectString(@OsUntrusted JMap.CppMap this) {
    ...
    @Override
    void genSetRTIFilter(@OsUntrusted JMap.CppMap this, @OsUntrusted CodeBuffer cb) {
  ...
  public @OsUntrusted JMap(@OsUntrusted JType t1, @OsUntrusted JType t2) {
    setJavaType(new @OsUntrusted JavaMap(t1.getJavaType(), t2.getJavaType()));
    setCppType(new @OsUntrusted CppMap(t1.getCppType(), t2.getCppType()));
  ...
  @Override
  @OsUntrusted
  String getSignature(@OsUntrusted JMap this) {

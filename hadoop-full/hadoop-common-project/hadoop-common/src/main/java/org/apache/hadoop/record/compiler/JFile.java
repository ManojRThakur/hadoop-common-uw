...
public class JFile {
  ...
  private @OsUntrusted String mName;
  /** Ordered list of included files */
  private @OsUntrusted ArrayList<@OsUntrusted JFile> mInclFiles;
  /** Ordered list of records declared in this file */
  private @OsUntrusted ArrayList<@OsUntrusted JRecord> mRecords;
   ...
   */
  public @OsUntrusted JFile(@OsUntrusted String name, @OsUntrusted ArrayList<@OsUntrusted JFile> inclFiles,
               @OsUntrusted
               ArrayList<@OsUntrusted JRecord> recList) {
    mName = name;
  ...
  @OsUntrusted
  String getName(@OsUntrusted JFile this) {
    @OsUntrusted
   ...
   *  lowercase.
   */
  public @OsUntrusted int genCode(@OsUntrusted JFile this, @OsUntrusted String language, @OsUntrusted String destDir, @OsUntrusted ArrayList<@OsUntrusted String> options)
    throws IOException {
    @OsUntrusted

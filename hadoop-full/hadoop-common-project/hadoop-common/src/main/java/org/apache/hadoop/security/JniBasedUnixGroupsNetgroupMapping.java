...
public class JniBasedUnixGroupsNetgroupMapping
  extends @OsUntrusted JniBasedUnixGroupsMapping {
  
  private static final @OsUntrusted Log LOG = LogFactory.getLog(
    JniBasedUnixGroupsNetgroupMapping.class);

  native @OsTrusted String @OsUntrusted [] getUsersForNetgroupJNI(@OsUntrusted JniBasedUnixGroupsNetgroupMapping this, @OsTrusted String group);
   ...
   */
  @Override
  public @OsUntrusted List<@OsTrusted String> getGroups(@OsUntrusted JniBasedUnixGroupsNetgroupMapping this, @OsTrusted String user) throws IOException {
   ...
   */
  @Override
  public void cacheGroupsRefresh(@OsUntrusted JniBasedUnixGroupsNetgroupMapping this) throws IOException {
    @OsUntrusted
   ...
   */
  @Override
  public void cacheGroupsAdd(@OsUntrusted JniBasedUnixGroupsNetgroupMapping this, @OsUntrusted List<@OsTrusted String> groups) throws IOException {
  ...
  protected synchronized @OsUntrusted List<@OsTrusted String> getUsersForNetgroup(@OsUntrusted JniBasedUnixGroupsNetgroupMapping this, @OsTrusted String netgroup) {
    @OsTrusted String @OsUntrusted [] users = null;
    try {
      // JNI code does not expect '@' at the begining of the group name
      users = getUsersForNetgroupJNI( (@OsTrusted String) netgroup.substring(1));
    ...
    return new @OsUntrusted LinkedList<@OsTrusted String>();
  }
}

...
public interface FenceMethod {
   ...
   */
  public void checkArgs(@OsUntrusted FenceMethod this, @OsUntrusted String args) throws BadFencingConfigurationException;
   ...
   */
  public @OsUntrusted boolean tryFence(@OsUntrusted FenceMethod this, @OsUntrusted HAServiceTarget target, @OsTrusted String args)
